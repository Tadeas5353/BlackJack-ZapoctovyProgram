...
Atribut úroveň značí schopnosti hráče. Je reprezentován číslem od nuly do čtyř. Nula značí manuální ovládání (v textové verzi to značí pětka). Jedna pak nejslabšího hráče, čtyři naopak nejsilnějšího. Podorobněji jsou úrovně popsány v návodu ke hře.
